...
export const EVENT_BASED_TRIGGER_URL =
  'https://triggers-one.vercel.app/triggers/event-based'

export const ALLOWED_VALIDATORS = {
  OWNABLE_VALIDATOR: '0x6605F8785E09a245DD558e55F9A0f4A508434503',
